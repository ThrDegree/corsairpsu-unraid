...
AX1600i support added by bngoold and ThrDegree, using a Python-based USB monitor that communicates with the PSU directly (matching how iCUE reads data), with per-PCIe-connector 12V current and power display.
